...
const CONFIG_DIR = join(homedir(), ".operator");
const THEME_PREFERENCES_PATH = join(
  CONFIG_DIR,
  "preferences.json",
);
...
function persistTheme(theme: Theme) {
  try {
    ...
    // Ignore preference write failures so theme switching still works for this sessions.
  }
}
